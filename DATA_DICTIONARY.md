...
| `phase_top_recipients_public.csv` | 三局面における上位宛先の集計。未確認宛先は住所を伏せたまま表示 | 確認済みコントラクトのみ | 表2 |
...
| `jpyc_direct_transfer_fee_summary_jpy.csv` | JPYC直接ERC-20 transferの匿名化済み費用要約 | なし | 図2・表1 |
